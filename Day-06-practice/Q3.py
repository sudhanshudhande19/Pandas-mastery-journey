...
result = pd.pivot_table(df ,values='Sales',index='City',columns='Product',aggfunc='mean')
print(result)

print(pd.pivot_table(df,values='Sales',index='City',columns='Product',aggfunc='count'))